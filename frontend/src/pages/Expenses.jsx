    ...
    <div >
      <div className='row '>
        ...
        <div className='col-md-9 m-5 p-3 rounded' style={{ height: '80vh', width: '130vh', backgroundColor: 'rgb(195, 250, 230', overscrollBehavior: '' }}>
          ...
          <div className='row'>
            <div className='mt-4 pt-2 w-100 rounded' style={{ backgroundColor: 'white', height: '60px', textAlign: 'center' }}><h5 style={{ fontSize: '20px', overflowY: 'hidden' }}>Total Expense: ₹15000</h5></div>
